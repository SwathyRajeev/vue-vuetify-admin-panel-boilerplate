...
export default {
  ...
  methods: {
    ...
    getName(state_id) {
      ...
      console.log(data);
      return data;
      // return this.states.forEach((element) => {
      //   if (element.id === state_id) {
    ...
    deleteItemConfirm() {
      axios
        .delete("district/" + this.editedItem.id)
        .then((res) => {
          if (res.code === 200) {
            // this.$swal(res.data.message);
            this.alert.color = "green--text";
            this.alert.title = "Success";
            this.alert.message = "District Deleted";
    ...
    async save() {
      ...
      if (this.editedIndex > -1) {
        await axios
          .patch("district/" + this.editedItem.id, {
        ...
        if (
          ...
          this.alert.color = "red--text";
          this.alert.title = "Error";
          this.alert.message = "Please fill District";
          this.alert.type = true;
        } else {
          // let data = {
          //   label: this.editedItem.label,
          ...
          await axios
            ...
            .then((res) => {
              if (res.data) {
                ...
                this.alert.color = "green--text";
                this.alert.title = "Success";
                this.alert.message = "District " + res.statusText;
                this.alert.type = true;
                console.log("res");
                console.log(res);
